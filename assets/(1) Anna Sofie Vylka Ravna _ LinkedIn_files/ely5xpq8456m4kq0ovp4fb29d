...
this.closeSearch()
break
case q:this.handleTabbing(e)}}onInputChange(e){this.searchTerm=e.target.value;(0,m.cancelDebounce)(this,"_searchGifs");(0,m.debounceTask)(this,"_searchGifs",600)}selectGif(e){var t,r
